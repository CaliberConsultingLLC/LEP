...
export default async function handler(req, res) {
    ...
    try {
        const response = await openai.chat.completions.create({
            model: "gpt-4",
            messages: [
                { role: "system", content: "Analyze leadership traits based on user input and provide recommended traits that they should focus on for their own incremental development." },
